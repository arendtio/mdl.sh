...
# start module https://mdl.sh/module/module-compiler-0.9.5.sh
moduleCompiler() {(
...
# start module https://mdl.sh/module/module-fetch-0.9.5.sh
moduleFetch() {(
# mandatory parameters
url="$1"

# dependencies
# start module https://mdl.sh/colon-config/colon-config-evaluated-0.9.2.sh
colonConfigEvaluated() {(
# parameters are defined in colon-config

# dependencies
# start module https://mdl.sh/colon-config/colon-config-0.9.1.sh
colonConfig() {(
# parameters
...
# end module https://mdl.sh/colon-config/colon-config-0.9.1.sh

value="$(colonConfig "$@")"
eval "printf '%s ' $value | sed 's/ \$/\\n/g'" # to evaluate variables like: $XDG_DATA_HOME
)}
# end module https://mdl.sh/colon-config/colon-config-evaluated-0.9.2.sh
...
# end module https://mdl.sh/error/error-1.0.1.sh
# start module https://mdl.sh/tmp-dir-by-user-keyword/tmp-dir-by-user-keyword-0.9.3.sh
tmpDirByUserKeyword() {(
...
# end module https://mdl.sh/tmp-dir-by-user-keyword/tmp-dir-by-user-keyword-0.9.3.sh
# start module https://mdl.sh/cache/cache-0.9.4.sh
cache() {(
...
# end module https://mdl.sh/cache/cache-0.9.4.sh
...
# end module https://mdl.sh/module/module-fetch-0.9.5.sh
...
# end module https://mdl.sh/module/module-compiler-0.9.5.sh
