...
# start module https://mdl.sh/module/module-compiler-0.9.0.sh
moduleCompiler() {(
...
# start module https://mdl.sh/module/module-validate-0.9.0.sh
moduleValidate() {(
src="$1"
checksum="$2"
...
# end module https://mdl.sh/module/module-validate-0.9.0.sh
...
# end module https://mdl.sh/module/module-compiler-0.9.0.sh
