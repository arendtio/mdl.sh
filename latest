...
# start module https://mdl.sh/module/core/module-core-0.9.17.sh
module() {
...
# start module https://mdl.sh/module/fetch/module-fetch-0.9.16.sh
moduleFetch() { (
set -eu
...
# end module https://mdl.sh/module/fetch/module-fetch-0.9.16.sh
...
# start module https://mdl.sh/module/validate/module-validate-0.9.6.sh
moduleValidate() { (
set -eu
src="$1"
targetHash="$2"

# start module https://mdl.sh/module/checksum/module-checksum-0.9.5.sh
moduleChecksum() { (
set -eu
...
# end module https://mdl.sh/module/checksum/module-checksum-0.9.5.sh
...
# end module https://mdl.sh/module/validate/module-validate-0.9.6.sh
...
# end module https://mdl.sh/module/core/module-core-0.9.17.sh
