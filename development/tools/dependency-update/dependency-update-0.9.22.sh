...
module "filterOld" "https://mdl.sh/development/module/dependency/filter/filter-old-0.9.1.sh" "cksum-340324812"
module "updatable" "https://mdl.sh/development/module/dependency/updatable/updatable-0.9.2.sh" "cksum-3016228237"
module "update" "https://mdl.sh/development/module/dependency/update/update-0.9.3.sh" "cksum-1998049951"
