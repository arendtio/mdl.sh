...
# start module https://mdl.sh/development/module/core/module-core-0.9.19.sh
module() {
...
# end module https://mdl.sh/development/module/validate/module-validate-0.9.8.sh
		...
		src="$(printf 'AAA'; moduleFetch "$location"; printf 'ZZZ')"
...
# end module https://mdl.sh/development/module/core/module-core-0.9.19.sh
