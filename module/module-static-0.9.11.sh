...
module() {
	# eval module code
	eval "$(
# start module https://mdl.sh/error/error-1.0.2.sh
error() { (
set -eu
# mandatory:
# error message
...
# end module https://mdl.sh/error/error-1.0.2.sh
# start module https://mdl.sh/module/module-fetch-0.9.13.sh
moduleFetch() { (
set -eu
...
# start module https://mdl.sh/https-get/https-get-1.0.4.sh
httpsGet() { (
set -eu
# mandatory:
url="$1"
...
# end module https://mdl.sh/https-get/https-get-1.0.4.sh
# start module https://mdl.sh/error/error-1.0.2.sh
error() { (
set -eu
# mandatory:
...
# end module https://mdl.sh/module/module-fetch-0.9.13.sh
...
# start module https://mdl.sh/module/module-validate-0.9.3.sh
moduleValidate() { (
set -eu
src="$1"
targetHash="$2"

# start module https://mdl.sh/module/module-checksum-0.9.1.sh
moduleChecksum() { (
set -eu
# mandatory:
# content
...
# end module https://mdl.sh/module/module-checksum-0.9.1.sh
...
# end module https://mdl.sh/module/module-validate-0.9.3.sh
