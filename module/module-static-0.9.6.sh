...
# start module https://mdl.sh/module/module-fetch-0.9.6.sh
moduleFetch() {(
# mandatory parameters
url="$1"

# dependencies
# start module https://mdl.sh/colon-config/colon-config-evaluated-0.9.3.sh
...
# end module https://mdl.sh/colon-config/colon-config-evaluated-0.9.3.sh
...
# end module https://mdl.sh/module/module-fetch-0.9.6.sh
