...
module "filterOld" "https://mdl.sh/module/dependency/filter/filter-old-0.9.0.sh" "cksum-4201147884"
module "updatable" "https://mdl.sh/module/dependency/updatable/updatable-0.9.0.sh" "cksum-468103183"
module "update" "https://mdl.sh/module/dependency/update/update-0.9.0.sh" "cksum-3434270692"
