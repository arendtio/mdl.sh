...
module "moduleDependencyExtract" "https://mdl.sh/module/dependency/extract/module-dependency-extract-0.9.0.sh" "cksum-3538423199"
module "findVersion" "https://mdl.sh/mdl/find-version/find-version-0.9.8.sh" "cksum-1173470263"
module "moduleFetch" "https://mdl.sh/module/fetch/module-fetch-0.9.19.sh" "cksum-3857111902"
