...
# dependencies
module "colonConfigEvaluated" "https://mdl.sh/colon-config/colon-config-evaluated-0.9.3.sh" "cksum-1582860756"
...
module "githubList" "https://mdl.sh/github/list/github-list-0.9.3.sh" "cksum-2611330514"
