...
module "mdlList" "https://mdl.sh/mdl/list/mdl-list-0.9.12.sh" "cksum-58821878"
...
module "specTestRun" "https://mdl.sh/spec-test/run/spec-test-run-0.9.5.sh" "cksum-1602969323"
specTestRun "$@"')"
